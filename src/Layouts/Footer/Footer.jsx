...
const Footer = () => {
  return (
    ...
    <div className="footer py-3">
      <div
        className="d-flex customflex my-5 container"
      ...
      >
        ...
        <div className="c_details">
          <h3 className="m-2 my-4" style={{ textAlign: "start" }}>
            Get in Touch
            <i
              class="fa-solid fa-arrow-right mx-3"
              style={{ color: "#5662ea", fontWeight: "600" }}
            ></i>
          </h3>
          <div
            className="my-2 d-flex hor"
            style={{ justifyContent: "space-between" }}
          >
            <div
            ...
            >
              <h4>EMAIL ME: </h4>
              <p style={{ fontSize: "20px" }}>munir230204@gmail.com</p>
            </div>
            <div
            ...
            >
              <h4>CALL ME: </h4>
              <p style={{ fontSize: "20px" }}>(+91)96994 73589</p>
            </div>
          </div>
        </div>
      </div>
